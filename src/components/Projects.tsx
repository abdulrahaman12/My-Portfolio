...
export default function Projects() {
  const projects = [{
    ...
    description: 'Web application to manage and track employee leave and work-from-home requests with real-time approval workflows and comprehensive admin console.',
    tech: ['React.js', 'TypeScript', 'React-bootstrap', '.NET Core', 'SSMS', 'REST APIs'],
  ...
  },
  {
    ...
    description: 'Application to assess stress levels based on user inputs. Integrated a Machine Learning model in backend for real-time analysis and predictions.',
    ...
    description: 'Designed and developed user-friendly, highly responsive web interfaces meeting UI/UX requirements while improving performance and user engagement.',
  ...
  },
  {
    ...
    description: 'Leveraged Context API for state management in React JS applications, simplifying complex state handling and increasing code maintainability.',
  ...
  },
  {
    ...
    description: 'Collaborated with back-end developers to seamlessly integrate front-end components, improving performance and reducing load time for applications.',
    ...
    description: 'Developed a product to calculate part and assembly costs by processing key design and manufacturing inputs. Ensured accurate cost estimations for engineering teams.',
    tech: ['React.js', 'Node.js', 'REST APIs', 'JavaScript', 'TypeScript'],
    image: 'https://images.pexels.com/photos/3184303/pexels-photo-3184303.jpeg?auto=compress&cs=tinysrgb&w=800',
    github: 'https://github.com/abdulrahaman12/',
    demo: 'https://example.com',
  },
  ]
  return (
